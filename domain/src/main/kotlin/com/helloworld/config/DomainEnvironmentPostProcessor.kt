...
class DomainEnvironmentPostProcessor : EnvironmentPostProcessor, Ordered {
    ...
    override fun postProcessEnvironment(environment: ConfigurableEnvironment?, application: SpringApplication?) {
        ...
        try {
            resources = resourcePatternResolver.getResources("classpath*:/application-domain.properties")
        } catch (e: IOException) {
            println(e.message)
        }
