...
class LineItemEntity(
    ...
    fun getTotalAmount(): BigDecimal =
        amount.plus(lineItemOptions.sumOf { it.getTotalAmount() }).multiply(quantity.toBigDecimal())

    fun getTotalSalesAmount(): BigDecimal =
        salesAmount.plus(lineItemOptions.sumOf { it.getTotalSalesAmount() }).multiply(quantity.toBigDecimal())

    fun getTotalDiscountAmount(): BigDecimal =
        discountAmount.plus(lineItemOptions.sumOf { it.getTotalDiscountAmount() }).multiply(quantity.toBigDecimal())
