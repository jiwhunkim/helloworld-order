package com.helloworld.order.redis.config
...
@Configuration
@EnableRedisRepositories(enableKeyspaceEvents = RedisKeyValueAdapter.EnableKeyspaceEvents.ON_DEMAND, keyspaceNotificationsConfigParameter = "")
class RedisConfig {
    @Bean
    ...
    fun redisLockRegistry(redisConnectionFactory: RedisConnectionFactory): RedisLockRegistry {
        return RedisLockRegistry(redisConnectionFactory, "helloworld-order")
    }
}