...
class DomainMapperEnvironmentPostProcessor : EnvironmentPostProcessor, Ordered {
    ...
    override fun postProcessEnvironment(environment: ConfigurableEnvironment?, application: SpringApplication?) {
        ...
        try {
            resources = resourcePatternResolver.getResources("classpath*:/application-domain-mapper.properties")
        } catch (e: IOException) {
            println(e.message)
        }
